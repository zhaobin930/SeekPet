<%@ Control Language="vb" AutoEventWireup="false" Inherits="EasySite.Modules.C_Info.TreeModules"
    CodeBehind="TreeModules.vb" %>
    ...
    <tr>
        <td>
            <ComponentWeb:TreeView id="TreeViewModules" Height="400" Width="300" DragAndDropEnabled="false"
                ...
                LineImagesFolderUrl="~/desktopmodules/C_Info/images/lines/" runat="server">
