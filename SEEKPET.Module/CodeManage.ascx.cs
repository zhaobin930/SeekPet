...
{
    public partial class CodeManage : EasySite.Entities.Modules.PortalModuleBase
    {
        ...
        protected void cmdSearch_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (txtCode.Text != "") strOtherFilter += " And code like '%" + txtCode.Text + "%'";
        ...
        protected void grdList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "commanddelete":
                    SqlDataProvider.SqlDataProvider.DeleteSee_Codes(grdList.DataKeys[e.Item.ItemIndex].ToString());
                    break;
            }
            grdList.BindData();
            wuPager.RefreshUI();
