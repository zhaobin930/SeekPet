...
{
    public partial class AnimalSeekManage : EasySite.Entities.Modules.PortalModuleBase
    {
        ...
        protected void cmdSearch_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (txtFeature.Text != "") strOtherFilter += " And Feature like '%" + txtFeature.Text + "%'";
                if (txtlossplace.Text != "") strOtherFilter += " And LossPlace like '%" + txtlossplace.Text + "%'";
                if (txtcity.Text != "") strOtherFilter += " And city like '%" + txtcity.Text + "%'";
        ...
        protected void grdList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "commanddelete":
                    SqlDataProvider.SqlDataProvider.DeleteSee_Seeks(grdList.DataKeys[e.Item.ItemIndex].ToString());
                    break;
            }
            grdList.BindData();
            wuPager.RefreshUI();
